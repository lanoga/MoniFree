...
<template>
  <aside
    ref="sidebar"
    :class="`absolute left-0 top-0 z-[9998] flex h-screen w-72.5 flex-col overflow-y-hidden bg-black duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${
